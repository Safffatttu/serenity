...
ErrorOr<String> FileEventModel::column_name(int column) const
{
    ...
    case Column::TotalCount:
        return TRY("Total Count"_string);
    case Column::TotalDuration:
        return TRY("Total Duration [ms]"_string);
    case Column::OpenCount:
        return TRY("Open Count"_string);
    case Column::OpenDuration:
        return TRY("Open Duration [ms]"_string);
    case Column::CloseCount:
        return TRY("Close Count"_string);
    case Column::CloseDuration:
        return TRY("Close Duration [ms]"_string);
    case Column::ReadvCount:
        return TRY("Readv Count"_string);
    case Column::ReadvDuration:
        return TRY("Readv Duration [ms]"_string);
    case Column::ReadCount:
        return TRY("Read Count"_string);
    case Column::ReadDuration:
        return TRY("Read Duration [ms]"_string);
    case Column::PreadCount:
        return TRY("Pread Count"_string);
    case Column::PreadDuration:
        return TRY("Pread Duration [ms]"_string);
    default:
        VERIFY_NOT_REACHED();
    }
}
